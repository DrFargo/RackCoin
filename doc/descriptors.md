# Support for Output Descriptors in Rackcoin Core

Since Rackcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Rackcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Rackcoin Core wallets, a convenience function `combo` is
