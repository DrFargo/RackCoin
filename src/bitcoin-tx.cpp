...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rackcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rackcoin-tx [options] <hex-tx> [commands]  Update hex-encoded rackcoin transaction\n" +
            "or:     rackcoin-tx [options] -create [commands]   Create hex-encoded rackcoin transaction\n" +
            "\n";
