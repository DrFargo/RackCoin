...
const char * const BITCOIN_CONF_FILENAME = "rackcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Rackcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Rackcoin";
#else
    // Unix
    return pathRet / ".rackcoin";
#endif
#endif
}
