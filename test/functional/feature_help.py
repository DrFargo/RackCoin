...
"""Verify that starting rackcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rackcoin with -h for help text")
        ...
        self.log.info("Start rackcoin with -version for version information")
        ...
        self.log.info("Start rackcoind with -fakearg to make sure it does not start")
